...
class CPipeStepR2TC(CPipeStep):
    ...
    def batch_run(self):
            if True:
                ...
                affine0 = {"iter": "1000", "smooth": "4vox", "shrink": "8"}
                affine1 = {"iter": "250", "smooth": "2vox", "shrink": "4"}
                affine2 = {"iter": "200", "smooth": "1vox", "shrink": "2"}
                affine3 = {"iter": "50", "smooth": "1vox", "shrink": "1"}
                
                COMMAND = "ITK_GLOBAL_DEFAULT_NUMBER_OF_THREADS=20 "+ants_reg+" -d 3 -v 1  \
                                                    --float 1 \
                                                    ...
                                                    -c ["+affine0["iter"]+", 1.e-8, 20]  \
                                                    -s "+affine0["smooth"]+"  \
                                                    -f "+affine0["shrink"]+"  \
                                                    --transform affine[ 0.05 ] \
                                                    -m Mattes["+FIX+","+MOVE+",1,32,Random,0.125] \
                                                    -c ["+affine1["iter"]+", 1.e-8, 20]  \
                                                    -s "+affine1["smooth"]+"  \
                                                    -f "+affine1["shrink"]+"  \
                                                    --transform affine[ 0.05 ] \
                                                    -m Mattes["+FIX+","+MOVE+",1,32,Random,0.0125] \
                                                    -c ["+affine2["iter"]+", 1.e-8, 20]  \
                                                    -s "+affine2["smooth"]+"  \
                                                    -f "+affine2["shrink"]+"  \
                                                    --transform affine[ 0.05 ] \
                                                    -m Mattes["+FIX+","+MOVE+",1,32,Random,0.063] \
                                                    -c ["+affine3["iter"]+", 1.e-8, 20]  \
                                                    -s "+affine3["smooth"]+"  \
                                                    -f "+affine3["shrink"]+"  \
                                                    --transform SyN[ 0.05,3,0 ] \
                                                    -m Mattes["+FIX+","+MOVE+",1,32,Random,0.125] \
                                                    -c [1000x500x100x50, 1.e-10, 20]  \
                                                    -s 4x2x1x1vox  \
                                                    -f 8x4x2x1 "

 

                affine0 = {"iter": "1000", "smooth": "3vox", "shrink": "8"}
                affine1 = {"iter": "250", "smooth": "2vox", "shrink": "4"}
                affine2 = {"iter": "200", "smooth": "1vox", "shrink": "2"}
                affine3 = {"iter": "100", "smooth": "0vox", "shrink": "1"}    
                ...
                COMMAND = "ITK_GLOBAL_DEFAULT_NUMBER_OF_THREADS=20 "+ants_reg+" -d 3 -v 1  \
                                                    ...
                                                    -m CC["+FIX+","+MOVE+",1,4,Random,0.125] \
                                                    -c [1000x500x50x25, 1.e-10, 20]  \
                                                    -s 3x2x1x0vox  \
                                                    -f 8x4x2x1 "
                ...
                COMMAND = "ITK_GLOBAL_DEFAULT_NUMBER_OF_THREADS=40 "+ants_reg+" -d 3 -v 1  \
                                                    --float 1 \
                                                    --winsorize-image-intensities [0.005,0.995] \
                                                    --write-composite-transform 1 \
                                                    "+PRETRAFO+" \
                ...
                COMMAND = "ITK_GLOBAL_DEFAULT_NUMBER_OF_THREADS=40 "+ants_reg+" -d 3 -v 1  \
                                                    ...
                                                    --masks [Null,"+MASK+"] \
                                                    -m Mattes["+FIX+","+MOVE+",0.5,32,Random,0.25] \
                                                        -m CC["+FIX+","+MOVE+",0.5,4,Random,0.25] \
                                                    -c [1000x500x100x50, 1.e-10, 20]  \
                                                    -s 3x2x1x0vox  \
                                                    -f 8x4x2x1 "
